...
public class SqlDateUtil {
	...
	public static String getSql(String startTime, String endTime) {
		...
		if(StringUtil.isNullOrBlank(startTime) && StringUtil.isNullOrBlank(endTime)){
			sql = "SELECT  P.CORDERID,P.PK_CORP,P.CBIZTYPE,P.CPURORGANIZATION,P.CVENDORBASEID,P.CEMPLOYEEID,P.CDEPTID,P.BRETURN,P.DORDERDATE,"
				  +" P.VMEMO,P.COPERATOR,P.CREVISEPSN,P.CAUDITPSN,P.DAUDITDATE,P.FORDERSTATUS,P.TMAKETIME"
	    		  +" FROM PO_ORDER P  "
	    		  +" where to_date(TMAKETIME,'yyyy-MM-dd hh24 mi ss') between sysdate-1/24  and  sysdate-1/48";
		}else{
			sql = "SELECT  P.CORDERID,P.PK_CORP,P.CBIZTYPE,P.CPURORGANIZATION,P.CVENDORBASEID,P.CEMPLOYEEID,P.CDEPTID,P.BRETURN,P.DORDERDATE,"
					  +" P.VMEMO,P.COPERATOR,P.CREVISEPSN,P.CAUDITPSN,P.DAUDITDATE,P.FORDERSTATUS,P.TMAKETIME"
		    		  +" FROM PO_ORDER P  "
		    		  +" where to_date(TMAKETIME,'yyyy-MM-dd hh24 mi ss') between to_date('"+startTime+"','yyyy-MM-dd hh24 mi ss')  and  to_date('"+endTime+"','yyyy-MM-dd hh24 mi ss')";
		}
		return sql;
	}
	 ...
	 * @return 
	 */
	public static String getDetailSql(String sql) {
		String str = "SELECT B.CORDERID,C.INVCODE,C.INVNAME,C.INVSPEC,B.CASSISTUNIT,B.NORDERNUM,B.NORGTAXPRICE,B.NORIGINALCURPRICE,B.NDISCOUNTRATE,"
			       +" B.NMONEY,B.IDISCOUNTTAXTYPE,B.NTAXRATE,B.NTAXPRICEMNY,b.coperator"
			   	+" FROM PO_ORDER_B B,BD_INVBASDOC C "
			   	+" WHERE B.CBASEID = C.PK_INVBASDOC AND B.CORDERID = '"+sql+"'";
